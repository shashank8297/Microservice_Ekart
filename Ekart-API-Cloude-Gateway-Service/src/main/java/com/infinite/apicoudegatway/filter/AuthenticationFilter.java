		...
		return ((exchange, chain) -> {
			...
			if (routeValidator.isSecured.test(exchange.getRequest())) {
				...
				try {
					...
					//restTemplate.getForObject("http://10.4.33.15:9010/auth/validate/"+authHeader, String.class);
					//restTemplate.getForObject("http://10.4.33.15:9010//validate/"+authHeader, String.class);
